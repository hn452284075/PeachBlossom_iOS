...
//    if (!isEmpty(self.qrCodeUrl)) {//裁剪
//        CGFloat scale_screen = kScreenWidth/kScreenHeight;
//        ZZTailoringVC *vc = [[ZZTailoringVC alloc] initWithImage:_chooseArray[0] cropFrame:CGRectMake(0, 64, kScreenWidth, kScreenHeight/2+scale_screen*kScreenWidth-49)];
//        vc.qrCodeUrl = _qrCodeUrl;
//        vc.dataArr = _dataArr;
