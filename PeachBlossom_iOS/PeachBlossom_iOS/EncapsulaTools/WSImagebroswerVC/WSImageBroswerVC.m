...
- (void)initLeftItem {
    self.leftBackButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 55, 26)];
    [self.leftBackButton setImage:[UIImage imageNamed:@"wphoto_back"] forState:UIControlStateNormal];
