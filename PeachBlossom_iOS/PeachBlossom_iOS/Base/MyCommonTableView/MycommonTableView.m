...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.configurecellBlock(tableView,model,cell,indexPath.row);
    return cell;
}
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    }else if (self.firstSectionHeaderViewName) {
        if (self.configurefirstSectionHeaderBlock) {
            self.configurefirstSectionHeaderBlock(tableView,nil,self.headView);
        }
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    }else if (self.firstSectionFooterViewName){
        if (self.configureTablefirstSectionFooterBlock) {
            self.configureTablefirstSectionFooterBlock(tableView,nil,self.footerView);
        }
                       ...
                       clickCell:(ClickTableCellBlock)clickCellBlock
{
    ...
    self.cellIdentifer = [identifier stringByAppendingString:@"ID"];
    [self registerClass:cellClassName forCellReuseIdentifier:self.cellIdentifer];
...
{
    self.configurefirstSectionHeaderBlock = configurefirstSectionHeaderBlock;
    self.firstSectionHeaderViewName = firstSectionHeaderViewName;
...
- (void)configureFirstSectioFooterViewName:(NSString *)firstSectionFooterViewName
     ...
     ConfigureTablefirstSectionFooterBlock:(ConfigureTablefirstSectionFooterBlock)configurefirstSectionFooterBlock{
    self.configureTablefirstSectionFooterBlock = configurefirstSectionFooterBlock;
    self.firstSectionFooterViewName = firstSectionFooterViewName;
