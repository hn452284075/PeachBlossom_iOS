...
//          
//            [GlobleErrorView showInContentView:[UIApplication sharedApplication].keyWindow withReloadBlock:^{
//                
//            } alertTitle:@"网络已断开，请检查您的网络！" alertImageName:@"网络错误状态"];
//            
//            
//        }else{
//            [GlobleErrorView showLoadingInView:[UIApplication sharedApplication].keyWindow];
//        }
